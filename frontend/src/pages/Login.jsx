...
export default function Login() {
  ...
  return (
    <React.Fragment>
      <div className="mx-auto mt-5 flex flex-col items-center w-4/5 md:w-1/2 border-2 border-indigo-900 bg-indigo-50 rounded-2xl">
        <div className="my-4 text-xl uppercase text-indigo-900 font-bold">
          LOGIN
        </div>
        <form
        ...
        >
          <div className="ml-4 my-2">
            <label className="text-indigo-900 font-semibold" htmlFor="username">
              Username:
            </label>
          </div>
          <div className="">
          ...
          <div className="my-4 ml-4">
            <label className="text-indigo-900 font-semibold" htmlFor="password">
              Password:
            </label>
          </div>
