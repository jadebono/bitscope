...
export default function Contact(props) {
  ...
  const form = (
    <div className="flex justify-center mt-5 mb-20 md:my-10">
      <div className="flex-col flex justify-center items-center w-4/5 md:w-1/3 bg-blue-50 rounded-2xl border-2 border-blue-700">
